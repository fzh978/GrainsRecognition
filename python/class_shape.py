...
class my_SHAPE(object):
	...
	def _get_contours_largest(self):
		...
		for cnt in self.contours:
			...
			if moments['m00'] != 0:     #由定义式 0阶距表示面积 or cv2.contourArea()
	...
	def get_humoments(self):
		...
		Hu_2 = cv2.HuMoments(moments)[1][0]
...
#	sys.exit(0)
	...
	for i in range(1, 11):
		mypreprocess = my_Preprocess("../data/grains/" + prefix_name +'/'+ str(i) + ".jpg", [150, 150])
