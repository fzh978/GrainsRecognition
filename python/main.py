...
if __name__ == '__main__':
	svm = my_SVM()
	svm_param_C, svm_param_gamma =10000.0,0.01
	
	trained_model_filename = "../data/cv2_svm_model.xml"
	
	features_train = my_Features('../data/grain_list.csv', '../data/grain_features_pre.csv')
...
#	features_train.save_features()
	...
	# load test csv
	features_test = my_Features('../data/test_list.csv', '../data/test_features_pre.csv')
